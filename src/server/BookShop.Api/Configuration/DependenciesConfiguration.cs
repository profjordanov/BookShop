...
namespace BookShop.Api.Configuration
{
    public static class DependenciesConfiguration
    {
        ...
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            {
                setup.SwaggerDoc("v1", new Info { Title = "BookShop.Api", Version = "v1" });
                setup.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "BookShop.Api.Documentation.xml"));
            });
        }
    }
}
